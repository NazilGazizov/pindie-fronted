...
export const RegisterForm = () => {
    ...
    <form className={Styles['form']}>
        ...
        <label className={Styles['form__field']}>
            ...
            <input onInput={handleInput} name="username" className={Styles['form__field-input']} type="username"/>
        </label>
        <label className={Styles['form__field']}>
        ...
        <div className={Styles['form__actions']}>
            <button className={Styles['form__submit']} type='submit' onClick={handleRegister}>Зарегистрироваться</button>
